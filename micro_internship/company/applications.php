...
<div class="container">
    <div class="page-title">
        ...
        <p>Review student profiles and accept or reject applications.</p>
    </div>
    ...
    <div class="table-box">
        <table>
            ...
            <tr>
                ...
                <td><?php echo $row["average_rating"]; ?> / 5</td>
                <td><span class="status"><?php echo $row["status"]; ?></span></td>
                <td><?php echo $row["deadline"] ? $row["deadline"] : "Not Assigned"; ?></td>
                <td>
                    <?php if($row["status"] == "Pending") { ?>
                        <a class="btn btn-green" href="accept_application.php?app_id=<?php echo $row["application_id"]; ?>">Accept</a>
                        <a class="btn btn-red" href="reject_application.php?app_id=<?php echo $row["application_id"]; ?>">Reject</a>
                    <?php } else { echo "-"; } ?>
                </td>
            </tr>
            <?php } ?>
